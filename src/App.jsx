...
import OutstandingReceivableV3 from '@/pages/reports/OutstandingReceivableV3';
...
import SmartFinancePage from '@/pages/admin/SmartFinancePage';
        ...
        <Router>
          ...
          <Route path="/home-preview" element={<HomePagePreview />} />
              ...
              <Route path="mto-cost-template" element={<MTOCostTemplatePage />} />
                    ...
                    <Route path="outstanding-receivable-v3" element={<OutstandingReceivableV3 />} />
