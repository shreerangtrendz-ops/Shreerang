...
/* ‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê‚ïê
   DESIGN LIFECYCLE PAGE ‚Ä" Complete journey: Grey ‚Ü' Mill ‚Ü' REC ‚Ü' Sale
...
const fmt     = n => '‚Çπ' + Math.abs(Number(n||0)).toLocaleString('en-IN',{maximumFractionDigits:0});
const fmtRate = n => n != null && n !== '' ? `‚Çπ${Math.abs(Number(n)).toFixed(2)}/m` : '‚Ä"';
const fmtMtr  = n => Number(n||0).toLocaleString('en-IN',{maximumFractionDigits:2}) + ' m';
const fmtDate = d => d ? new Date(d).toLocaleDateString('en-IN',{day:'numeric',month:'short',year:'2-digit'}) : '‚Ä"';
const fmtPct  = n => n != null ? `${Math.abs(Number(n)).toFixed(1)}%` : '‚Ä"';
const fmtL    = n => { const v=Math.abs(Number(n||0)); return v>=10000000?`‚Çπ${(v/10000000).toFixed(2)}Cr`:v>=100000?`‚Çπ${(v/100000).toFixed(1)}L`:fmt(n); };
...
// ‚"Ä‚"Ä Small UI atoms ‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä
...
// ‚"Ä‚"Ä V-block wrappers ‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä
  ...
  return (
    <div style={{borderLeft:`4px solid ${borderColor}`,paddingLeft:14,marginBottom:10}}>
      <div style={{fontSize:10,fontWeight:800,color:borderColor,textTransform:'uppercase',
        ...
        {title}
        {subtitle && <span style={{fontWeight:500,color:T.textMuted,textTransform:'none',letterSpacing:0,fontSize:10}}>‚Ä" {subtitle}</span>}
      </div>
...
// ‚"Ä‚"Ä V-01 Grey Purchase ‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä
...
// ‚"Ä‚"Ä V-02 Issue to Mill ‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä

function IssueToMillBlock({ rows }) {
  if (!rows || rows.length === 0) {
    return (
      <VBlock title="V-02 ¬∑ Issue to Mill" borderColor={T.teal}>
        <GhostNote msg="Issue challan not synced ‚Ä" check n8n issue_to_mill table" />
      </VBlock>
    );
  }
  const itm = rows[0];
...
// ‚"Ä‚"Ä V-03 Jobwork Bill ‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä
// V-03 ‚Ü" V-04 link: rec_from_mill.jw_voucher_number = jobwork_expenses.voucher_number
// This is resolved by compute_jw_allocation() ‚Ä" NOT a direct field match.
// (supplier_invoice_no is the mill‚Äôs own invoice number; party_challan_no is our issue challan ‚Ä" different numbers)

function JobworkBlock({ row }) {
  if (!row) {
    return (
      <VBlock title="V-03 ¬∑ Jobwork Bill" borderColor={T.amber}>
        <GhostNote msg="Jobwork bill not yet matched ‚Ä" jw_voucher_number not set. Run SELECT * FROM compute_jw_allocation() to resolve." />
      </VBlock>
    );
  }
  ...
  return (
    <VBlock title="V-03 ¬∑ Jobwork Bill" subtitle={decodeHtml(row.voucher_number)} borderColor={T.amber}>
      ...
      <div style={{display:‚Äôflex‚Äô,gap:16,flexWrap:‚Äôwrap‚Äô,alignItems:‚Äôcenter‚Äô,marginBottom:10}}>
        <div>
          <div style={{fontSize:9,color:T.textMuted,fontWeight:700,textTransform:‚Äôuppercase‚Äô,
            letterSpacing:.5,marginBottom:2}}>JW Voucher No</div>
          <div style={{fontFamily:"‚ÄôDM Mono‚Äô,monospace",fontSize:13,fontWeight:800,color:T.amber}}>
            {decodeHtml(row.voucher_number)||‚Äô‚Ä"‚Äò}
          </div>
        </div>
        <div>
          <div style={{fontSize:9,color:T.textMuted,fontWeight:700,textTransform:‚Äôuppercase‚Äô,
        ...
        {row.supplier_invoice_no && (
          <div>
            <div style={{fontSize:9,color:T.textMuted,fontWeight:700,textTransform:‚Äôuppercase‚Äô,
              letterSpacing:.5,marginBottom:2}}>Mill‚Äôs Invoice No</div>
            <div style={{fontFamily:"‚ÄôDM Mono‚Äô,monospace",fontSize:12,color:T.text}}>
      ...
      {/* Bill amounts ‚Ä" keeping only correct fields */}
      <div style={{display:‚Äôgrid‚Äô,gridTemplateColumns:‚Äôrepeat(3,1fr)‚Äô,gap:‚Äô8px 16px‚Äô}}>
...
// ‚"Ä‚"Ä V-04 REC from Mill ‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä

function RecFromMillBlock({ rec, isFirstStage, jobworkRow }) {
  const mill      = decodeHtml(rec.mill_name || rec.job_godown) || '‚Ä"';
    ...
    <VBlock title="V-04 ¬∑ REC from Mill" subtitle={rec.tally_voucher_no} borderColor={T.green}>
      ...
      <div style={{display:'flex',gap:16,flexWrap:'wrap',alignItems:'center',marginBottom:10}}>
        <div>
          ...
          <div style={{fontSize:13,fontWeight:800,color:T.green,fontFamily:"'DM Mono',monospace"}}>{rec.tally_voucher_no||'‚Ä"'}</div>
        </div>
      ...
      {(greyItem || finishItem) && (
        <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:10,
          ...
          <div style={{textAlign:'center'}}>
            ...
            <div style={{fontSize:12,fontWeight:600,color:T.text}}>{greyItem||'‚Ä"'}</div>
          </div>
          <div style={{fontSize:20,color:T.textFaint,padding:'0 4px'}}>‚Ü'</div>
          <div style={{textAlign:'center'}}>
            <div style={{fontSize:9,color:T.green,fontWeight:700,textTransform:'uppercase',marginBottom:2}}>Finish Item</div>
            <div style={{fontSize:12,fontWeight:700,color:T.tealDark}}>{finishItem||'‚Ä"'}</div>
          </div>
        </div>
      )}
      ...
      <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:8,marginBottom:10}}>
        <div style={{padding:'8px 10px',background:T.blueLight,borderRadius:6,textAlign:'center'}}>
          ...
          <div style={{fontSize:13,fontWeight:700,color:T.text,fontFamily:"'DM Mono',monospace"}}>
            {rec.grey_issued_qty_mtrs ? fmtMtr(rec.grey_issued_qty_mtrs) : '‚Ä"'}
          </div>
        </div>
        <div style={{padding:'8px 10px',background:T.greenLight,borderRadius:6,textAlign:'center'}}>
          ...
          <div style={{fontSize:13,fontWeight:700,color:T.green,fontFamily:"'DM Mono',monospace"}}>
            {rec.finish_qty_mtrs ? fmtMtr(rec.finish_qty_mtrs) : '‚Ä"'}
          </div>
        </div>
        <div style={{padding:'8px 10px',background:highShort?T.redLight:'#F8FAFB',borderRadius:6,textAlign:'center'}}>
          ...
          <div style={{fontSize:13,fontWeight:700,color:highShort?T.red:T.text,fontFamily:"'DM Mono',monospace"}}>
            {rec.shortage_mtrs ? fmtMtr(rec.shortage_mtrs) : '‚Ä"'}
          </div>
        </div>
        <div style={{padding:'8px 10px',background:highShort?T.redLight:'#F8FAFB',borderRadius:6,textAlign:'center'}}>
          ...
          <div style={{fontSize:13,fontWeight:700,color:highShort?T.red:T.text}}>
            {rec.shortage_pct != null ? fmtPct(rec.shortage_pct) : '‚Ä"'}
          </div>
        </div>
      </div>
...
// ‚"Ä‚"Ä Costing Summary box ‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä
          ...
          {sales.length === 0 ? (
            ...
            <>
              ...
              <div style={lineStyle}>
                ...
                <span style={{...valStyle,color:T.amber}}>‚à'{fmtRate(avgCommPerM)}</span>
              </div>
              <div style={lineStyle}>
              ...
              <div style={lineStyle}>
                ...
                <span style={{...valStyle,color:T.red}}>‚à'{fmtRate(fullCost||factoryCostPerM)}</span>
              </div>
              {divider}
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'6px 0'}}>
...
// ‚"Ä‚"Ä Sales Section ‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä
    ...
    <div style={{borderLeft:`4px solid ${T.purple}`,paddingLeft:14}}>
      <div style={{fontSize:10,fontWeight:800,color:T.purple,textTransform:'uppercase',
        ...
        <span style={{fontWeight:500,color:T.textMuted,textTransform:'none',letterSpacing:0,marginLeft:6}}>
          ‚Ä" {sales.length} bill{sales.length!==1?'s':''}, {fmtMtr(totalQty)} total
        </span>
      </div>
              ...
              <tbody>
                {sales.map(b => (
                  <tr key={b.id} style={{transition:'background .1s'}}
                    ...
                    <td style={{...tdStyle,fontWeight:600}}>{decodeHtml(b.customer_name)||'‚Ä"'}</td>
                    <td style={{...tdStyle,color:T.textMuted,fontSize:11}}>{b.customer_state||'‚Ä"'}</td>
                    <td style={{...tdStyle,textAlign:'right',fontFamily:"'DM Mono',monospace"}}>
                      {b.quantity_mtrs ? fmtMtr(b.quantity_mtrs) : '‚Ä"'}
                    </td>
                    <td style={{...tdStyle,textAlign:'right',fontFamily:"'DM Mono',monospace"}}>
                      {b.rate_per_mtr ? `‚Çπ${Math.abs(Number(b.rate_per_mtr)).toFixed(2)}` : '‚Ä"'}
                    </td>
                    <td style={{...tdStyle,fontSize:11}}>
                      {decodeHtml(b.broker_name)||<span style={{color:T.textFaint}}>‚Ä"</span>}
                    </td>
                    <td style={{...tdStyle,textAlign:'right'}}>
                      {b.comm_rate
                        ...
                        : <span style={{color:T.textFaint}}>‚Ä"</span>}
                    </td>
...
// ‚"Ä‚"Ä Search / landing form ‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä
  ...
  return (
    <div style={{maxWidth:560,margin:'80px auto 0',padding:'0 24px',fontFamily:"'DM Sans',sans-serif"}}>
      <div style={{textAlign:'center',marginBottom:32}}>
        <div style={{fontSize:36,marginBottom:12}}>ü"ó</div>
        <h1 style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:28,color:T.tealDark,margin:'0 0 8px'}}>
          Design Lifecycle
        </h1>
        <p style={{fontSize:13,color:T.textMuted,margin:0}}>
          Trace any design from grey purchase ‚Ü' mill ‚Ü' REC ‚Ü' sale with full costing
        </p>
      </div>
...
// ‚"Ä‚"Ä Main component ‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä‚"Ä
...
export default function DesignLifecyclePage() {
  ...
  const [gpMap,            setGpMap]             = useState({});   // lot_no ‚Ü' [grey_purchase rows]
  const [itmMap,           setItmMap]            = useState({});   // lot_no ‚Ü' [issue_to_mill rows]
  const [jweMap,           setJweMap]            = useState({});   // voucher_number ‚Ü' [jobwork_expenses rows]
  ...
  // ‚"Ä‚"Ä If no design/lot param, show search form ‚"Ä‚"Ä
  ...
  // ‚"Ä‚"Ä Group REC rows by lot, then by stage ‚"Ä‚"Ä
  ...
  // ‚"Ä‚"Ä Derive header stats ‚"Ä‚"Ä
  const firstRec = recRows[0];
  const finishItemName = decodeHtml(firstRec?.finish_item_name) || '‚Ä"';
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:T.bg,minHeight:'100vh',
          ...
          <div>
            {loading ? (
              <div style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:32,
                color:T.textFaint}}>Loading‚Ä¶</div>
            ) : (
              <>
          ...
          {!loading && recRows.length > 0 && (
            <div style={{display:'flex',gap:10,flexWrap:'wrap'}}>
              ...
              <Pill label="Avg Factory Cost / m"
                value={avgFactoryCost ? fmtRate(avgFactoryCost) : '‚Ä"'} color={T.teal} />
              <Pill label="Avg Selling Rate"
                value={avgSellingRate ? fmtRate(avgSellingRate) : '‚Ä"'} color={T.green} />
              <Pill label="Avg Margin"
                value={avgMarginPct != null ? `${avgMarginPct >= 0 ? '+' : ''}${avgMarginPct.toFixed(1)}%` : '‚Ä"'}
      ...
      {!loading && !error && recRows.length === 0 && (
        <div style={{padding:60,textAlign:'center',background:T.surface,border:`1px solid ${T.border}`,
          borderRadius:14}}>
          <div style={{fontSize:40,marginBottom:12}}>ü"ç</div>
      ...
      {/* ‚"Ä‚"Ä Timeline: one section per lot ‚"Ä‚"Ä */}
                  ...
                  {stageIdx > 0 && (
                    <div style={{display:'flex',alignItems:'center',gap:10,
                      ...
                      <span style={{fontSize:11,color:T.textMuted,fontStyle:'italic'}}>
                        ‚Ü' Sent for further processing (Stage {rec.stage_no||stageIdx+1})
                      </span>
                    </div>
                  )}
      ...
      {/* ‚"Ä‚"Ä Sales section (global, across all lots for this design) ‚"Ä‚"Ä */}
      {!loading && recRows.length > 0 && (
