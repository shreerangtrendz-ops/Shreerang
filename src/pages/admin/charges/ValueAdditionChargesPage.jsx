...
const ValueAdditionChargesPage = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const data = await ValueAdditionService.listCharges({ 
        search, 
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-20">
      <Helmet><title>Value Addition Charges</title></Helmet>
      <AdminPageHeader 
        title="Value Addition Charges" 
        description="Manage embroidery, handwork, and other value addition costs."
        breadcrumbs={[{label: 'Dashboard', href: '/admin'}, {label: 'Value Addition'}]}
      />
        ...
        <div className="flex gap-2 w-full md:w-auto">
           ...
           <Select value={filterType} onValueChange={setFilterType}>
               ...
               <SelectContent>
                   ...
                   <SelectItem value="Schiffli">Schiffli</SelectItem>
...
export default ValueAdditionChargesPage;